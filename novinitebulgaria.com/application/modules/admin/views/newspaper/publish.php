...
<form role="form" method="POST" action="" enctype="multipart/form-data">
    ...
    <div class="form-group for-shop">
        ...
        <input type="text" name="image_link" class="form-control" value="<?= isset($_POST['image_link']) ? $_POST['image_link'] : '' ?>" placeholder="http://google.com/image.jpg">
    </div>
    <div class="form-group for-shop">
    ...
    <div class="form-group for-shop">
        ...
        <select class="selectpicker" name="ageRestrict">
            <option value="1" <?= isset($_POST['ageRestrict']) && $_POST['ageRestrict'] == 1 ? 'selected' : '' ?>>Yes</option>
            <option value="0" <?= isset($_POST['ageRestrict']) && $_POST['ageRestrict'] == 0 || !isset($_POST['ageRestrict']) ? 'selected' : '' ?>>No</option>
        </select>
    </div>
    <div class="form-group for-shop">
        <label>TOP NEWS</label>
        <select class="selectpicker" name="topNews">
            <option value="1" <?= isset($_POST['topNews']) && $_POST['topNews'] == 1 ? 'selected' : '' ?>>Yes</option>
            <option value="0" <?= isset($_POST['topNews']) && $_POST['topNews'] == 0 || !isset($_POST['topNews']) ? 'selected' : '' ?>>No</option>
        </select>
    </div>
