...
//BLOG
$route[rawurlencode('блог') . '/' . rawurlencode('категория') . '/(:any)'] = 'blog/index/$1';
$route['(\w{2})/' . rawurlencode('блог') . '/' . rawurlencode('категория') . '/(:any)'] = "blog/index/$2";
$route[rawurlencode('блог') . '/(:any)'] = 'blog/post/$1';
$route['(\w{2})/' . rawurlencode('блог') . '/(:any)'] = "blog/post/$2";
$route[rawurlencode('блог')] = 'blog/index';
$route['(\w{2})/' . rawurlencode('блог')] = "blog/index";
...
$route['admin/categories/edit/(:num)'] = "admin/publisher/categories/index/$1";
$route['admin/categories/delete/(:num)'] = "admin/publisher/categories/delete/$1";
$route['admin/texts'] = "admin/publisher/texts";
$route['admin/texts/(:num)'] = "admin/publisher/texts/index/$1";
$route['admin/reservations'] = "admin/publisher/reservations";
$route['admin/reservations/(:num)'] = "admin/publisher/reservations/index/$1";
$route['admin/delete/reservation/(:num)'] = "admin/publisher/reservations/delete/$1";
$route['admin/callendar'] = "admin/publisher/callendar";
$route['admin/callendar/(:num)'] = "admin/publisher/callendar/index/$1";
...
$route['admin/blog/delete/category/(:num)'] = "admin/blog/deletecategory/$1";
...
$route['urlcategorychecker'] = 'admin/categories/urlcategorychecker';
$route['removeImage'] = 'admin/publisher/publish/removeOtherImage';
$route['blogpaging'] = 'blog/getmoreresults';
$route['urlblogcategorychecker'] = 'admin/blog/urlblogcategorychecker';
$route['urlblogchecker'] = 'admin/blog/urlblogchecker';
